...
*Note: Fill in exact MITRE ATT&CK technique IDs (e.g., T1498 for Network DoS, T1557 for AiTM) after cross-referencing attack.mitre.org directly, as instructed in the task brief.*
